        ...
        >
            {items?.map((c, i) => (
                <article
                    ...
                    className="group relative flex flex-col w-[280px] rounded-[24px] overflow-hidden border border-white/10 transition-all duration-300 cursor-pointer bg-[#0a0a0c]"
                    style={
                        {
                ...
                >
                    ...
                    <footer className="relative z-10 p-4 text-white font-sans">
                        <h3 className="m-0 text-[1.1rem] font-bold tracking-tight">{c.title}</h3>
                        <p className="m-0 text-[0.9rem] text-violet-400 font-medium">{c.subtitle}</p>
                    </footer>
                </article>
            ))}
        </div>
